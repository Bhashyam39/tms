...
st.set_page_config(
    page_title="Text Summarization", page_icon="🤗", layout="wide", initial_sidebar_state="expanded"
)
...
with st.sidebar:
    ...
    if 'hf_email' not in st.session_state or 'hf_pass' not in st.session_state:
        with st.expander("ℹ️ Login in Hugging Face", expanded=True):
            ...
            hf_email = 'sbhashyam970@gmail.com'
            hf_pass = 'Sravan@1214'
            hf_token = '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'
            if st.button('Login 🚀') and hf_email and hf_pass and hf_token: 
                with st.spinner('🚀 Logging in...'):
                    ...
                    if 'generated' not in st.session_state:
                        st.session_state['generated'] = ["I'm **Text Summarizer**. I'm here to summarize the text given to me"]
